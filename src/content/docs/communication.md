...
description: What incident command should verify during an emergency — and how the church speaks to media and social media.
---

During an incident, the **incident commander** should ensure:
...
- [ ] **Spokesperson assigned** — see [media & social media playbook](#media-and-social-media-playbook) below
- [ ] **All clear** authorized only by IC/backup
- [ ] **Post-incident debrief** scheduled within 72 hours

## Spokesperson roster

Only these people speak for the church to **press, social media, or the wider congregation** during and immediately after an incident. Everyone else: **no posts, no comments, no “what I heard.”**
...
## Media and social media playbook

Use this during **Code Red, Code Blue, medical emergencies that draw attention, or any event where reporters or social media may react** — even if no code was sounded.

### Golden rules (active incident)

1. **One voice.** Only the designated spokesperson (or backup) talks to media or posts on official channels.
2. **Facts from IC only.** Spokesperson repeats what IC and first responders have confirmed — not hallway rumors.
3. **Protect people.** No names of victims, children, or staff without permission and legal review. No photos or video of minors, injured persons, or law-enforcement tactics.
4. **No speculation.** Do not guess motive, number of injuries, or whether the building is “safe” until IC and fire/LE say so.
5. **Silence is OK.** A short holding statement beats a wrong statement.

### What everyone else does

| Do | Don't |
|----|--------|
| Point reporters to the spokesperson | Give interviews or “background” quotes |
| Lock personal social accounts if tempted to react | Post, comment, or share unverified details |
| Tell IC if media arrives or a post is going viral | Debate or argue online during an active incident |
| Use private channels for family check-ins | Live-stream, TikTok, or Facebook Live from campus |

Staff and members should **not** tag the church, elders, or “@” official accounts asking for updates during an active event — that adds noise the spokesperson must manage.
...
5. Get reporter **name, outlet, and phone/email** for follow-up after all clear.
...
- Number or names of injured, missing, or detained
- Photos from inside the building during the event
- Blame, political commentary, or speculation
- Details that could help a bad actor (entry points, security gaps, staff locations)

### Congregation & parents (non-press)

Separate from media — often more urgent than Twitter.
...
Message should be **short, factual, and calm**. Link to where the next update will appear. Do not overload with detail.
...
## What the horns do vs. what people do

| Campus horns (Arnold Alert) | People |
|----------------------------|--------|
| Announce Code Red or Blue | Execute evacuation or lockdown |
| Loop until all clear | Call 911, sweep rooms, count kids |
| Play Code Green on all clear | Stand down per IC |

Horns do **not** call parents, lock doors, tell rooms which exit to use, or speak to the media — that is in this playbook and classroom handouts.
