...
|------|---------|------------|
| **Code Red** | Evacuate | Leave the building; go to assembly area |
| **Code Blue** | Lockdown | Secure room; lights off; phones silent |
| **All clear** | Emergency over | Resume normal — **only when leadership says so** |
