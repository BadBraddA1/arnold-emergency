...
| Arnold Alert | Medical event |
|--------------|---------------|
| Plays Code Red / Blue on **Campus Horns** | Does **not** dial 911 |
...
- [ ] Confirm 911 en route
- [ ] Decide if **Code Red** or **Code Blue** is needed (usually **no**)
- [ ] Brief pulpit / teachers if worship or classes are in session
- [ ] Nursery: keep children in place unless evacuation ordered

### After EMS leaves

- [ ] [Post-incident debrief](/post-incident/) within 72 hours if significant
- [ ] Update this page if gaps found
